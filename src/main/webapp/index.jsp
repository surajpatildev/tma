...
<body>
	...
	<div class="jumbotron text-center row" id="jumbo">
		...
		<div class="box col-lg-8 col-md-8 col-sm-10 jumbo">
			<h3 class="h1">Practice Aptitude Tests for Job Applicants &
				Graduates.</h3>
			<p>Aptitude and ability tests are designed to assess your logical
				reasoning or thinking performance.</p>
			<a href="test.jsp" class="btn btn-info btn-lg text-uppercase">Take a Sample
					tEST</a><br>
			<br>
		</div>
